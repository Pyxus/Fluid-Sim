...
namespace FluidSim.Old
{
    ...
    public class Cell : Node2D
    {
        ...
        private ColorRect LiquidSprite;
        ...
        {
            base._Ready();
            LiquidSprite = new ColorRect();
            AddChild(LiquidSprite);
            LiquidSprite.RectSize = new Vector2(1, 1);
        ...
        public void Update()
        {
            ...
            if (Type == CellType.Solid)
            {
                //BackgroundSprite.color = Colors.Black;
            }
            else
            {
                //BackgroundSprite.color = Colors.White;
            }
            ...
            LiquidSprite.RectScale = new Vector2(1, Mathf.Min(1, Liquid));
            ...
            if (!RenderFloatingLiquid)
            {
                ...
                {
                    LiquidSprite.RectScale = new Vector2(0, 0);
                }
            }
            ...
            if (RenderDownFlowingLiquid)
            {
                ...
                {
                    LiquidSprite.RectScale = new Vector2(1, 1);
                }
            }

            // Set color based on pressure in cell
            var r = Mathf.Lerp(Color.r, DarkColor.r, Liquid / 4f);
            var g = Mathf.Lerp(Color.g, DarkColor.g, Liquid / 4f);
            var b = Mathf.Lerp(Color.b, DarkColor.b, Liquid / 4f);
            var a = Mathf.Lerp(Color.a, DarkColor.a, Liquid / 4f);
            LiquidSprite.Color = new Color(r, g, b, a);
        }
    }
}